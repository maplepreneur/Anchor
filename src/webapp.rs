...
fn seed_firefox_profile(profile: &Path) -> Result<()> {
    ...
    let user_chrome = r#"/* Zorin Web App Manager — minimal web-app chrome */
#TabsToolbar,
#nav-bar,
#PersonalToolbar,
#statuspanel {
...
"#;
    ...
    let user_js = r#"// Generated by Zorin Web App Manager
...
mod integration {
    ...
    fn create_list_delete_with_local_icon() {
        ...
        assert!(desktop.contains("X-WebApp-Manager=zorin-webapp-manager"));
